        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-40 lg:px-40">
                <div class="pt-10 pb-5">
                    <img src="https://www.gobiernoabierto.ec/wp-content/uploads/2020/01/Logo-Esquel-color.png" alt="">
                ...
                <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg centrar" >
                        ...
                        <div class="p-20">
                            ...
                            <form action="ejemplo.php" method="get" >
                                        ...
                                        <p class=" text-white py-2 px-4 font-bold mt-5 izquierda" >Cédula o Pasaporte: 
                                        </p> <select name="menu">
                                        ...
                                        <p class=" text-white py-2 px-4 font-bold mt-1 izquierda" >Escribe los dígitos: 
                                        ...
                                        <p class=" text-white py-2 px-4 font-bold mt-5 izquierda" >Sexo:  
